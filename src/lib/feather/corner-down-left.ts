...
export class IconCornerDownLeftComponent {}

@NgModule({
  declarations: [ IconCornerDownLeftComponent ],
  entryComponents: [ IconCornerDownLeftComponent ],
  exports: [ IconCornerDownLeftComponent ]
})
