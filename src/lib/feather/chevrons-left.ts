...
export class IconChevronsLeftComponent {}

@NgModule({
  declarations: [ IconChevronsLeftComponent ],
  entryComponents: [ IconChevronsLeftComponent ],
  exports: [ IconChevronsLeftComponent ]
})
